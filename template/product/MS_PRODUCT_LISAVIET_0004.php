...
<div class="gb-chitiet_sanpham_lisaviet">

    <div class="gb-chitiet_sanpham_lisaviet-body">

        <div class="container">

            <div class="gb-chitiet_sanpham_lisaviet-left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="gb-chitiet_sanpham_LISAVIET_left-img">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="gb-chitiet_sanpham_LISAVIET_left-info">
                            ...
                            <?php include DIR_CART."MS_CART_LISAVIET_0002.php";?>
                            ...
                            <div class="gb-lienhe-product_lisaviet">

                                Hotline: <?= $rowConfig['content_home6'] ?>
                            ...
                            <?php include DIR_SOCIAL."MS_SOCIAL_LISAVIET_0002.php";?>
                ...
                <?php include DIR_PRODUCT."MS_PRODUCT_LISAVIET_0005.php";?>
