...
<?php
    ...
    $list_trademark = $action->getList('trademark','','','id','asc','','','');
    $trademark_arr = explode(',', $row['trademark_arr']);
?>
...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <select name="trademark_id[]" class="selectpicker" multiple>
            <?php 
                foreach ($list_trademark as $item) {
                    if (in_array($item['id'], $trademark_arr)) {
